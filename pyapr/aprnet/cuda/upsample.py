...
from _pyaprwrapper.aprnet.cuda import upsample_const_forward, upsample_const_backward
...
class UpsampleConstFunction(Function):
    ...
    def backward(ctx, grad_output):
        ...
        grad_input = upsample_const_backward(APRPtrVector(aprs), grad_output.contiguous(), level_deltas)
